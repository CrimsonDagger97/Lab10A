...
public class Lab10Ast extends Applet
{
    ...
    public static void flagOfItaly (Graphics g)
    {
        ...
        for (int d = 1; d <= numDots; d++)
        {
            int x = Expo.random(0,1000);       // random x valu e of each dot
            int y = Expo.random(0,650);        // random y value of each dot
    ...
    public static void flagOfNorway (Graphics g)
    {
      Expo.setBackground(g,Expo.black);
      Expo.setBackground(g,Expo.black);
        for (int d = 1; d <= numDots; d++)
        {
            ...
            if (x >= 200 && x <= 325)           // middle stripe requires compound condition
                Expo.setColor(g,Expo.white);
                
            if (y >= 225 && y <= 350)           // middle stripe requires compound condition
                Expo.setColor(g,Expo.white);

            if (x >=225 && x <= 300 ) //Vertical blue stripe
                Expo.setColor(g,Expo.blue);
                
            if (y >=250 && y <= 325) //Vertical blue stripe
                Expo.setColor(g,Expo.blue);
    ...
    {
        Expo.setBackground(g,Expo.grey);
        for (int d = 1; d <= numDots; d++)
        {
            int x = Expo.random(0,1000);       // random x valu e of each dot
            int y = Expo.random(0,650);        // random y value of each dot
